...
export function VisualIdentity() {
  return (
    <section id="visual-identity" className="space-y-8 pt-8 scroll-mt-20">
      ...
      <div className="space-y-6 pt-2 pb-8 border-b border-primary/10">
        <h3 className="text-xl font-semibold font-heading text-foreground">Brand Marks &amp; Photography</h3>
        <div className="grid md:grid-cols-2 gap-6 pt-2">
          
          {/* Logo Constraint */}
          <div className="bg-white/60 backdrop-blur-md rounded-lg border border-primary/10 p-6 shadow-sm overflow-hidden mix-blend-normal">
            <h4 className="font-ui font-semibold text-primary tracking-tight text-lg mb-2">The Canonical Mark</h4>
            ...
            <p className="text-sm text-muted-foreground mt-6 leading-relaxed font-sans pb-2">
              <strong className="text-muted-foreground font-semibold">Clear Space Rule:</strong> Always maintain a protective boundary around the logo equal to the width of the &apos;B&apos;. <br/><br/>
            ...
            <div className="mt-4 pt-6 border-t border-primary/10 space-y-3">
              <span className="block text-xs font-bold text-muted-foreground uppercase tracking-widest">Secondary Assets</span>
              <div className="flex flex-wrap items-center gap-3">
                <div className="bg-white rounded overflow-hidden flex items-center justify-center border border-primary/10 shadow-sm w-10 h-10 shrink-0">
          ...
          <div className="bg-white/60 backdrop-blur-md rounded-lg border border-primary/10 p-6 shadow-sm">
            <h4 className="font-ui font-semibold text-primary tracking-tight text-lg mb-2">Team Photography</h4>
            ...
            <p className="text-sm text-muted-foreground mt-6 leading-relaxed font-sans">
              <strong className="text-muted-foreground font-semibold">Breathable Cropping:</strong> Never crop aggressively tight onto faces. Allow environmental headroom. <br/><br/>
              <strong className="text-muted-foreground font-semibold">Tone Rules:</strong> All team headshots and corporate imagery must be subjected to a cool-toned filter (<code>mix-blend-luminosity</code> or <code>grayscale</code>) to sit homogenously within our AI-ready glassmorphic architecture. Raw, unedited color photography shatters the UI immersion.
            </p>
          </div>
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold font-heading text-foreground">Color Palette</h3>
        <p className="text-sm text-muted-foreground flex items-center flex-wrap gap-1 relative z-10">
          Always ensure 
          <span className="relative group inline-flex items-center cursor-help text-primary font-medium border-b border-primary/30 border-dashed pb-[1px]">
            ...
            <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-72 p-4 bg-white/95 backdrop-blur-md border border-primary/10 text-foreground text-xs rounded-lg shadow-[0_8px_30px_rgba(0,0,0,0.08)] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 pointer-events-none text-left leading-relaxed">
        ...
        <div className="space-y-4 pt-8">
          <h4 className="text-md font-bold font-heading text-foreground uppercase tracking-widest">Approved Gradients</h4>
        ...
        <div className="mt-10 bg-white/60 backdrop-blur-md border border-primary/10 rounded-lg p-8 shadow-sm">
      ...
      <div className="space-y-4 pt-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="rounded-lg border border-[#059669]/20 bg-white/60 backdrop-blur-md p-5 space-y-4 shadow-sm">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">Used for confirmation mechanisms, completed milestones, and positive trajectory metrics.</p>
          ...
          <div className="rounded-lg border border-[#d97706]/20 bg-white/60 backdrop-blur-md p-5 space-y-4 shadow-sm">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">Used for destructive action confirmations, systemic bottlenecks, and pending authorizations.</p>
          ...
          <div className="rounded-lg border border-[#dc2626]/20 bg-white/60 backdrop-blur-md p-5 space-y-4 shadow-sm">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">Used exclusively for critical failures, integration blockages, and non-reversible actions.</p>
      ...
      <div className="space-y-6 pt-4">
        <h3 className="text-xl font-semibold font-heading text-foreground">Typographic Archetypes</h3>
        <p className="text-sm text-muted-foreground">
        ...
        <div className="grid gap-6">
          ...
          {/* Hero Display */}
          <div className="bg-white/60 backdrop-blur-md rounded-lg border border-primary/10 p-6 flex flex-col md:flex-row gap-6 md:items-center justify-between shadow-sm">
            <div className="space-y-2 max-w-lg">
              <div className="flex gap-3 items-baseline">
                <span className="text-xs font-mono text-primary font-bold tracking-widest uppercase">Hero Display</span>
                <span className="text-xs text-muted-foreground font-mono">Montserrat (700, 800)</span>
              </div>
              <h1 className="text-4xl sm:text-5xl font-display font-extrabold text-primary tracking-tight leading-none">
                Transformative Growth.
              </h1>
              <p className="text-xs text-muted-foreground">Used exclusively for landing page Hero H1s and massive brand pull-quotes.</p>
            </div>
            <a href="https://fonts.google.com/specimen/Montserrat" target="_blank" rel="noopener noreferrer" className="shrink-0 max-w-fit flex items-center justify-center gap-2 bg-white/50 hover:bg-white text-foreground border border-primary/10 px-4 py-2 rounded-lg text-xs font-medium transition-colors shadow-sm">
          ...
          <div className="bg-white/60 backdrop-blur-md rounded-lg border border-primary/10 p-6 flex flex-col md:flex-row gap-6 md:items-center justify-between shadow-sm">
            <div className="space-y-2 max-w-lg">
              <div className="flex gap-3 items-baseline">
                ...
                <span className="text-xs text-muted-foreground font-mono">Barlow (500, 600)</span>
              </div>
              <h2 className="text-4xl text-secondary font-data font-semibold tracking-wide">
                +34.2% Yield
              </h2>
              <p className="text-xs text-muted-foreground">Used exclusively for numerical ROI, tabular data, and highly structured technical micro-copy.</p>
            </div>
            <a href="https://fonts.google.com/specimen/Barlow" target="_blank" rel="noopener noreferrer" className="shrink-0 max-w-fit flex items-center justify-center gap-2 bg-white/50 hover:bg-white text-foreground border border-primary/10 px-4 py-2 rounded-lg text-xs font-medium transition-colors shadow-sm">
          ...
          <div className="bg-white/60 backdrop-blur-md rounded-lg border border-primary/10 p-6 flex flex-col md:flex-row gap-6 md:items-center justify-between shadow-sm">
            <div className="space-y-2 max-w-lg">
              <div className="flex gap-3 items-baseline">
                ...
                <span className="text-xs text-muted-foreground font-mono">Inter (400, 500, 600)</span>
              </div>
              <div className="flex gap-3">
                ...
                <button className="bg-neutral/5 border border-primary/10 text-foreground text-sm font-ui font-medium px-4 py-1.5 rounded-lg shadow-sm">Secondary</button>
              </div>
              <p className="text-xs text-muted-foreground">The backbone of our SaaS UI. Used for buttons, navs, and structural dashboard headings.</p>
            </div>
             <a href="https://fonts.google.com/specimen/Inter" target="_blank" rel="noopener noreferrer" className="shrink-0 max-w-fit flex items-center justify-center gap-2 bg-white/50 hover:bg-white text-foreground border border-primary/10 px-4 py-2 rounded-lg text-xs font-medium transition-colors shadow-sm">
          ...
          <div className="bg-white/60 backdrop-blur-md rounded-lg border border-primary/10 p-6 flex flex-col md:flex-row gap-6 md:items-center justify-between shadow-sm">
            <div className="space-y-2 max-w-lg">
              <div className="flex gap-3 items-baseline">
                ...
                <span className="text-xs text-muted-foreground font-mono">Public Sans (300, 400)</span>
              </div>
              ...
              <p className="text-xs text-muted-foreground pt-2">Used strictly for dense paragraphs, case studies, and extensive body copy.</p>
            </div>
             <a href="https://fonts.google.com/specimen/Public+Sans" target="_blank" rel="noopener noreferrer" className="shrink-0 max-w-fit flex items-center justify-center gap-2 bg-white/50 hover:bg-white text-foreground border border-primary/10 px-4 py-2 rounded-lg text-xs font-medium transition-colors shadow-sm">
...
function ColorSwatch({ name, hex, className, textColor, showTints = false }: { name: string, hex: string, className: string, textColor: string, showTints?: boolean }) {
  return (
    <div className="rounded-lg overflow-hidden border border-primary/10 shadow-sm transition-transform hover:scale-[1.02] flex flex-col h-full bg-white">
      ...
      {showTints && (
        <div className="flex flex-col w-full bg-white border-b border-primary/10">
          {[80, 60, 40, 20].map(opacity => (
            <div key={opacity} className="h-8 w-full flex items-center px-3 relative">
              ...
              <span className={`font-mono text-[10px] font-bold tracking-widest relative z-10 ${opacity > 40 ? textColor : 'text-muted-foreground mix-blend-multiply'}`}>
                {opacity}%
              </span>
            </div>
          ))}
...
function GradientSwatch({ name, gradient, description }: { name: string, gradient: string, description: string }) {
  return (
    <div className="rounded-lg overflow-hidden border border-primary/10 shadow-sm transition-transform hover:scale-[1.02]">
