             ...
             <div className="bg-white/5 border border-white/10 p-8 rounded-xl flex flex-col md:flex-row gap-6 items-start">
               ...
               <div>
                 ...
                 <div className="text-white/70 text-[15px] leading-relaxed space-y-4">
                   <p><EditableText element="span" contentId="sec_1_p1" defaultText="Bridge2Partners mandates FIPS 140-2 validated cryptography, encrypting all client data at rest with AES-256 and in transit via TLS 1.2+. We utilize centralized, cloud-native key management with automated 90-day rotation and immutable access logging to ensure no single system or engineer compromise can result in data exposure." isAdmin={isAdmin} value={cmsContent.sec_1_p1} documentId="procurement" /></p>
                 </div>
               </div>
             </div>
             <div className="bg-white/5 border border-white/10 p-8 rounded-xl flex flex-col md:flex-row gap-6 items-start">
               ...
               <div>
                 ...
                 <div className="text-white/70 text-[15px] leading-relaxed space-y-4">
                   <p><EditableText element="span" contentId="sec_2_p1" defaultText="Our Zero Trust architecture ensures no device or user is inherently trusted. All endpoints are centrally managed via MDM for remote wiping and patching, and are protected by next-generation EDR (like CrowdStrike Falcon) for automated threat isolation. Access to production systems and client data strictly requires hardware-key multi-factor authentication (MFA)." isAdmin={isAdmin} value={cmsContent.sec_2_p1} documentId="procurement" /></p>
                 </div>
               </div>
             </div>
             <div className="bg-white/5 border border-white/10 p-8 rounded-xl flex flex-col md:flex-row gap-6 items-start">
               ...
               <div>
                 ...
                 <div className="text-white/70 text-[15px] leading-relaxed space-y-4">
                   <p><EditableText element="span" contentId="sec_3_p1" defaultText="We execute a NIST-aligned Incident Response Plan (IRP) for rapid threat containment and SLA-driven client notification, rigorously tested via annual tabletop exercises. Our Business Continuity Plan (BCP) ensures high availability through active-active multi-region cloud deployments, continuous backups, and routine disaster recovery testing to maintain operational resilience." isAdmin={isAdmin} value={cmsContent.sec_3_p1} documentId="procurement" /></p>
                 </div>
               </div>
             </div>
          </div>
