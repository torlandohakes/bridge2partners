      ...
      <div className="max-w-6xl mx-auto px-6 py-24 relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16">
        <div className="space-y-8">
          <h2 className="text-3xl font-display font-bold text-[#98cc67]">
            <EditableText element="span" contentId="section_1_h2" defaultText="The Challenge" isAdmin={isAdmin} documentId="treasury" value={cmsContent.section_1_h2} />
          </h2>
          <div className="bg-white/5 border border-white/10 p-8 rounded-2xl min-h-[300px] flex items-center justify-center">
             <div className="text-white/50 border border-dashed border-white/20 p-6 w-full text-center rounded-xl bg-white/[0.02]">
               <EditableText element="p" contentId="section_1_p" defaultText="[Client Challenge Wireframe Block]" isAdmin={isAdmin} documentId="treasury" value={cmsContent.section_1_p} />
             </div>
          </div>
        </div>
        ...
        <div className="space-y-8">
          <h2 className="text-3xl font-display font-bold text-[#98cc67]">
            <EditableText element="span" contentId="section_2_h2" defaultText="How We Execute" isAdmin={isAdmin} documentId="treasury" value={cmsContent.section_2_h2} />
          </h2>
          <div className="bg-white/5 border border-white/10 p-8 rounded-2xl min-h-[300px] flex items-center justify-center">
             <div className="text-white/50 border border-dashed border-white/20 p-6 w-full text-center rounded-xl bg-white/[0.02]">
               <EditableText element="p" contentId="section_2_p" defaultText="[Execution Strategy Wireframe Block]" isAdmin={isAdmin} documentId="treasury" value={cmsContent.section_2_p} />
             </div>
          </div>
        </div>
      </div>
